    ...
    <div className="prj">
      <div class="card">
        ...
        <div class="card__descr-wrapper">
          <p class="card__title">Project 1</p>
          <p class="card__descr">
          At Ecom App, we take your security and privacy seriously. Our app uses state-of-the-art encryption and secure payment gateways to ensure your transactions are safe and protected.
          </p>
          <div class="card__links">
            <div>
              ...
              <a class="link" href="https://devrabic-ecom.web.app/">
                Preview
              </a>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card__img"></div>
        <div class="card__descr-wrapper">
          <p class="card__title">Project 2</p>
          <p class="card__descr">
          Perform calculations with ease using our intuitive calculator app, featuring basic arithmetic, advanced functions, unit conversions, and history tracking, all in a clean and modern design.
          </p>
          <div class="card__links">
            <div>
              <svg
              ...
              <a class="link" href="simple calculator/index.html">
                Preview
              </a>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card__img"></div>
        <div class="card__descr-wrapper">
          <p class="card__title">Project 3</p>
          <p class="card__descr">
          Take our interactive quiz and assess your skills with a variety of questions, featuring instant feedback, scoring, and progress tracking, all in a user-friendly and engaging interface.
          </p>
          <div class="card__links">
            <div>
              <svg
              ...
              <a class="link" href="quiz form/index.html">
                Preview
              </a>
            </div>
          </div>
